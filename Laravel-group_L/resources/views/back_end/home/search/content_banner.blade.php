                ...
                @else
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('deleteBanner') }}?id={{ $value['banner_id'] }}" class="btn btn-danger pull left submitDelete" style="margin-right:3px;" source="{{ route('deleteBanner') }}?id={{ $value['banner_id'] }}">Delete</a>
                        </td>
                    </tr>
                    @endforeach
                @endif
