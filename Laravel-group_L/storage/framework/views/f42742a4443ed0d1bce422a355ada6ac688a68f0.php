							...
							<div class="wpb_text_column wpb_content_element white-box content-padding">
								<div class="wpb_wrapper">
									<h2 class="text-uppercase" style="text-align: left;">
										...
										<?php echo strtoupper($data->category_title); ?>

									</h2>
									<p><?php echo e($data->category_content); ?></p>
							...
							<div class="wpb_single_image wpb_content_element vc_align_left">
								<figure class="wpb_wrapper vc_figure">
									<div class="vc_single_image-wrapper vc_box_border_grey">
										<img width="750" height="563" src="<?php echo e($data->category_img); ?>" class="vc_single_image-img attachment-large" alt="content-rooms-3" sizes="(max-width: 750px) 100vw, 750px">
									</div>
								</figure>
							</div>
						</div>
